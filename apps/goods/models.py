...
class GoodsCategory(models.Model):
    ...
    # 其中help_text属性则会在后面的api文档中会使用的到；
    name = models.CharField(default='', max_length=30, verbose_name='类别名称', help_text='类别名称')
    code = models.CharField(default='', max_length=30, verbose_name='类别code', help_text='类别code')
    desc = models.TextField(default='', verbose_name='类别描述', help_text='类别描述')
    category_type = models.CharField(choices=CATEGORY_TYPE, verbose_name='类目级别', help_text='类目级别',max_length=50)
    # 其中related_name的用则在后面查询的时候会使用的到；
...
class GoodsCategorybrand(models.Model):
    ...
    商家品牌
    """
    # 下面这里加上related_name，然后在反向取的时候就方便，详情看goods/serializer/InndexCategorySerializer
    category = models.ForeignKey(GoodsCategory, null=True,blank=True,related_name="brands",verbose_name="商品类目", on_delete=models.CASCADE)
